...
//setting up google strategy and config it
...
app.get("/secrets",function(req,res){
    User.find({userSecret : {$exists : true}}, function(err,foundUsers){
        if(err){
            console.log(err);
        }
        else{
...
app.post("/submit",function(req,res){
    ...
    User.findById({_id : req.user.id},function(err,foundUser){
        if(err){
            ...
            if(foundUser){
                foundUser.userSecret = newSecret;
